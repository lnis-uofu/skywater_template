...
proc import_design {{how "init"}} {
   ...
   switch $how {
      "init"      {  uplevel #0 source CONF/${design}_final.globals
                     init_design
                     save_design import
                  }
...
proc add_power_nets {} {
   ...
   source /uusoc/facility/cad_common/skywater-src-nda/scs8hd/V0.0.2/scripts/add_taps.tcl
...
proc export_design {} {
   ...
   streamOut "GDS/${design}.gds" \
             -mapFile  /uusoc/facility/cad_common/skywater-src-nda/scs8hd/V0.0.2/oa/scs8hd_dv/scs8hd_dv.layermap \
             -libName DesignLib \
             -structureName $design \
       -units 2000 -mode ALL
    write_netlist GDS/${design}_lvs_netlist.v -phys -exclude_leaf_cells
    source /uusoc/facility/cad_common/skywater-src-nda/scs8hd/V0.0.2/scripts/lvstext.tcl
}
